    ...
    <div className="rounded-[8px] border border-[#26262B] bg-[#141417] p-5 space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-[#9C9CA4] leading-[1.5]">
      ...
      {isDecision && (
        <div className="space-y-3 pt-1">
          <label className="block">
            <span className="font-mono text-2xs tracking-[0.12em] uppercase text-[#9C9CA4]">
            ...
            <input
              ...
              className="mt-1.5 w-full h-10 px-3 rounded-xl border border-[#26262B] bg-[#101013] text-sm focus-ring"
            />
          </label>
          ...
          <button
            onClick={() => save(1)}
            disabled={saving}
            className="h-9 px-4 rounded-xl bg-[#141417] text-[#F0F0EE] text-sm font-semibold hover:opacity-90 transition-opacity focus-ring disabled:opacity-50"
          >
