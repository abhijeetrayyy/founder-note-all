  ...
  return (
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-12">
      <Card className="p-8 text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-foreground font-display">Note not found</h2>
        <p className="text-sm text-foreground-muted">
          This note doesn&apos;t exist or was deleted.
        </p>
        <Link href="/notes" className="inline-block pt-2">
          <Button className="h-11 px-6">Go to Notes</Button>
        </Link>
      </Card>
    </div>
  );
